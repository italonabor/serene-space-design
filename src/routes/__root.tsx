...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dra. Nayara Justimiano | Psicologia" },
      {
        name: "description",
        content:
          "Psicoterapia acolhedora para ansiedade, TDAH e autismo com a Dra. Nayara Justimiano.",
      },
      { name: "author", content: "Dra. Nayara Justimiano" },
